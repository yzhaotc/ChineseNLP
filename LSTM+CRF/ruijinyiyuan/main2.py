...
flags.DEFINE_string("train_file",   os.path.join(root_path+"datas", "example1.train"),  "Path for train data")
flags.DEFINE_string("dev_file",     os.path.join(root_path+"datas", "example1.dev"),    "Path for dev data")
flags.DEFINE_string("test_file",    os.path.join(root_path+"datas", "example1.test"),   "Path for test data")
