...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_data', type=str, default='./person_data/train.txt')
    parser.add_argument('--dev_data', type=str, default='./person_data/dev.txt')
    parser.add_argument('--test_data', type=str, default='./person_data/test.txt')
