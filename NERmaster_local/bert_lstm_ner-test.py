    ...
    def get_labels(self, labels=None):
        ...
        if os.path.exists(os.path.join(self.output_dir, 'label_list.pkl')):
            ...
            if len(self.labels) > 0:
                ...
                # 标准地址
                # self.labels = ["O", 'B-COUNTY', 'I-COUNTY', "B-STREET", "I-STREET", "B-COMMUNITY", "I-COMMUNITY",
                #                "B-ROAD", "I-ROAD", "B-NUM", "I-NUM", "B-POI", "I-POI", "B-CITY", "I-CITY", "B-VILLAGE",
                #                "I-VILLAGE", "X", "[CLS]", "[SEP]"]

                # 人名识别
                self.labels = ["O", 'B-TIME', 'I-TIME', "B-LOCATION", "I-LOCATION", "B-PERSON_NAME", "I-PERSON_NAME",
                               "B-ORG_NAME", "I-ORG_NAME", "B-COMPANY_NAME", "I-COMPANY_NAME", "B-PRODUCT_NAME",
                               "I-PRODUCT_NAME", "X", "[CLS]", "[SEP]"]
        return self.labels
...
def zjb_eval(output_dir, data_dir, max_seq_length,
             vocab_file, batch_size, learning_rate, init_checkpoint, bert_config_file, num_train_epochs):
...
if __name__ == '__main__':
    ...
    zjb_eval(output_dir, data_dir, max_seq_length,
             vocab_file, batch_size, learning_rate,
             init_checkpoint, bert_config_file, num_train_epochs)
